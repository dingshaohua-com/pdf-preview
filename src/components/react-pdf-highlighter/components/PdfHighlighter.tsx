  ...
  renderHighlights(nextProps?: Props<T_HT>) {
    ...
    for (let pageNumber = 1; pageNumber <= pdfDocument.numPages; pageNumber++) {
      ...
      if (highlightLayer) {
        ...
        // ReactDOM.render(vNode, highlightLayer as HTMLElement)
          // const root = ReactDomCli.createRoot(highlightLayer);
          // root.render(vNode);
        // ReactDOM.createPortal('<div>好啦</div>', highlightLayer);
          // ReactDOM.render(vNode, highlightLayer as HTMLElement)
          const root = ReactDomCli.createRoot(highlightLayer);
          root.render(vNode);
      }
    ...
    return (
      <div onPointerDown={this.onMouseDown}>
        <div
          ...
          onScroll={(e) => {(this.props as any).onPhScroll(e)}}
